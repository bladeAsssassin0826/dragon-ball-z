...
function preload(){
  ...
  friezablock=loadAnimation("frieza_block-removebg-preview.png")
...
function setup(){
  ...
  frieza.addAnimation("friezaBlock",friezablock)
...
if(rand===1){
  ...
  if(keyDown("t")){
    frieza.changeAnimation("friezaBlock",friezablock)
    frieza.scale=0.7
  }
